...
out = check_output("ctags -x --c-types=f ./interface.cpp", shell=True).decode("utf-8")
print(out)
fp = open("interface.h", "w")
fp.write("#ifndef _ETELINTERFACEH_\n")
fp.write("#define _ETELINTERFACEH_\n")
fp.write("\n")
fp.write("#define ETEL_OO_API\n")
fp.write("#include <conio.h>\n")
fp.write("#include <dex40.h>\n")
fp.write("#include <esd40.h>\n")
fp.write("#include <etb40.h>\n")
fp.write("#include <dsa40.h>\n")
fp.write("#include <lib40.h>\n")
fp.write("#include <tra40.h>\n")
...
for f in fn[:]:
    if f == "":
        continue
    temp = f.split("./interface.cpp")[1].strip()
