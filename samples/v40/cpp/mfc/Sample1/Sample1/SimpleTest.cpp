...
BEGIN_MESSAGE_MAP(CSimpleTestApp, CWinApp)
ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()

// CSimpleTestApp construction

CSimpleTestApp::CSimpleTestApp()
{
}

// The one and only CSimpleTestApp object

CSimpleTestApp theApp;

// CSimpleTestApp initialization

BOOL CSimpleTestApp::InitInstance()
{
